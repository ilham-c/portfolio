const Projects = [
{
    title:"Plannifiez le développement du site de votre client",
    description:"Mis en place d'une veille technologique, rédaction des spécifications techniques du projet, et d'un tableau kanban.",
    image:"/assets/qwenta.webp",
    alt:"Une coupe de glace posé sur un journal",
    tools:["React","Javascript","Notion","Figma","Feedly","Agile","Scrum","GitHub"],
},
{
...
},
{
    ...
    alt:"Un groupe de personnes regardant dans la même direction",
...
},
{
    ...
    alt:"Photo d'un couple lors de leur cérémonie de mariage",
...
},
{
    ...
    alt:"Appartement joliement décoré",
...
},
{
    ...
    alt:"Photo d'une jeune femme au milieu de la nature",
...
},
{
    ...
    alt:"Homme tenant un journal, on y voit un logo Printit",
...
},
{
    ...
    alt:"Site d'une agence de voyage",
